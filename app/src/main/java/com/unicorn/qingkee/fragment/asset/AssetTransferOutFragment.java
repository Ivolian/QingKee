...
public class AssetTransferOutFragment extends AssetsFragment {
    ...
    public int getLayoutResourceId() {
        return R.layout.fragment_asset_transfer_out;
    }
    ...
    public void confirm() {
        ...
        String assetSort = assetList.get(0).getAssetSort();
        if (assetSort.equals("1")) {
...
//        }
    ...
    private String getUrl() {
        Uri.Builder builder = Uri.parse(UrlUtils.getBaseUrl() + "/AssetTransferOut?").buildUpon();
