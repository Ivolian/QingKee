...
public class PhotoPagerActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mViewPager.setAdapter(new SamplePagerAdapter(getIntent().getStringArrayListExtra("photoPathList")));
        mViewPager.setCurrentItem(getIntent().getIntExtra("photoIndex",0));
    }
    ...
    class SamplePagerAdapter extends PagerAdapter {
        ...
        SamplePagerAdapter(ArrayList<String> photoPathList) {
        ...
        public View instantiateItem(ViewGroup container, int position) {
            ...
            String photoPath = photoPathList.get(position);
